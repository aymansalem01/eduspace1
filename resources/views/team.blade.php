...
<html lang="en">
  <head>
    ...
    />
    <!-- Stylesheet -->
    <link rel="stylesheet" href="assest/css/team.css" />
  </head>
  <body>
    <section>
      <div class="row">
      ...
      <div class="row">
        ...
        <div class="column">
          <div class="card">
            <div class="img-container">
              ...
              <img src="assest/image/Tala.jpeg" alt="Tala Wassas" />
            </div>
            <h3>Tala Wassas</h3>
            <p>AI Student</p>
            <div class="icons">
        ...
        <div class="column">
          <div class="card">
            <div class="img-container">
              <img src="assest/image/Lujain.jpeg" alt="Lujain Samara" />
            </div>
            <h3>Lujain Samara</h3>
            <p>SE student</p>
            <div class="icons">
        ...
        <div class="column">
          <div class="card">
            <div class="img-container">
              <img src="assest/image/Ayman.jpeg" alt="Ayman Aborumman" />
            </div>
...
<div class="column">
  <div class="card batool-card">
    <div class="img-container">
      <img src="assest/image/Batool.jpeg" alt="Batool Ennab" />
    </div>
    <h3>Batool Ennab</h3>
    <p>AI Student</p>
    <div class="icons">
      ...
      {{-- <a href="batoulennab17@gmail.com" aria-label="Email">
        ...
        <div class="column">
          <div class="card">
            <div class="img-container">
              <img src="assest/image/Rahaf.jpeg" alt="Rahaf Baseet" />
            </div>
            <h3>Rahaf Baseet</h3>
            <p>VR Student</p>
            <div class="icons">
    ...
    <script src="assest/js/team.js"></script>
